<html lang="ru">
	...
	<head>
		...
		<!-- TITLE -->
		<title>ONECLI. - Тестовая версия <?= isset($title) ? ' / ' . $title : null ?></title>
		<!-- CONNECT STYLES -->
		...
		<header class="main-header">
			...
			<div class="header-user-info div-flex df-spaceb">
				...
				<div class="main-user-info" onClick="onClickUserSubmenu()">
					...
					<?php
					  if($_SESSION['ava']){
						echo '<img class="user-header-image" src="/storage/avatars/'.$_SESSION['ava'].'" alt="Your image">';
					  }else{
						echo '<img class="user-header-image" src="images/standart-avatar.jpg" alt="Your image">';
					  }
					?>
				...
				<div class="socials" style="overflow:hidden">
				  ...
				  <div  id="socials-list" style="position:absolute; right:-190px;">
					<ul class="socials-list" >
						<li><a href="https://www.youtube.com/channel/UClxixUM9qzOjoFtUd5RNBzQ" target="_blank"><img id="soc_yt" src="/images/socials/yt0.png" style="cursor:pointer" onmouseover="chg('yt');" onmouseout="chg_('yt');" ></a></li>
						<li><a href="https://www.facebook.com/oneclicom/" target="_blank"><img id="soc_f" src="/images/socials/f0.png" style="cursor:pointer" onmouseover="chg('f');" onmouseout="chg_('f');" ></a></li>
						<li><a href="https://www.instagram.com/oneclicom/" target="_blank"><img id="soc_i" src="/images/socials/i0.png" style="cursor:pointer" onmouseover="chg('i');" onmouseout="chg_('i');" ></a></li>
						<li><a href="https://twitter.com/oneclicom" target="_blank"><img id="soc_tw" src="/images/socials/tw0.png" style="cursor:pointer" onmouseover="chg('tw');" onmouseout="chg_('tw');" ></a></li>
						<li><a href="https://teleg.one/onecli" target="_blank"><img id="soc_t" src="/images/socials/t0.png" style="cursor:pointer" onmouseover="chg('t');" onmouseout="chg_('t');" ></a></li>
						<li><a href="https://vk.com/onecli" target="_blank"><img id="soc_vk" src="/images/socials/vk0.png" style="cursor:pointer" onmouseover="chg('vk');" onmouseout="chg_('vk');" ></a></li>
					</ul>
				  </div>
				</div>
